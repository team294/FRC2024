...
public class TrajectoryCache {
    ...
    public enum TrajectoryType {
        ...
        driveCenterToFarNoteRed(7),
        driveCenterToFarNoteBlue(8);
    ...
    public TrajectoryCache(FileLog log){
        ...
        cache[TrajectoryType.driveToSourceCloseNoteRed.value] = new TrajectoryFacing(
            ...
            new Pose2d(2.5, 4.1, new Rotation2d(Math.toRadians(0))), 
            List.of(), 
        ...
        cache[TrajectoryType.driveToAmpCloseNoteRed.value] = new TrajectoryFacing(
            ...
            new Pose2d(2.5, 1.2, new Rotation2d(Math.toRadians(0))), 
            List.of(), 
        ...
        cache[TrajectoryType.driveCenterToFarNoteRed.value] = new TrajectoryFacing(
            new Rotation2d(0), 
            new Rotation2d(0), 
            calcTrajectory("Drive Center To Far Note Red", .4, .4, false,
            new Pose2d(2.5, 3.2, new Rotation2d(Math.toRadians(-30))), 
            List.of(
                new Translation2d(5.2, 1.2)
            ), 
            new Pose2d(8.2, 0.8, new Rotation2d(0))
            ));
        
        cache[TrajectoryType.driveCenterToFarNoteBlue.value] = new TrajectoryFacing(
            new Rotation2d(0), 
            new Rotation2d(0), 
            calcTrajectory("Drive Center To Far Note Red", .4, .4, false,
            new Pose2d(3.1, 5, new Rotation2d(Math.toRadians(30))), 
            List.of(
                new Translation2d(5.2, 7)
            ), 
