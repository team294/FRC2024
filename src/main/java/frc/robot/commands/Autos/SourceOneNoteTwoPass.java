...
public class SourceOneNoteTwoPass extends SequentialCommandGroup {
  /** Creates a new driveSourceOneNoteAuto. */
  public SourceOneNoteTwoPass(Intake intake, Wrist wrist, Shooter shooter, DriveTrain driveTrain, Feeder feeder, BCRRobotState robotState, AllianceSelection alliance, FileLog log) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new ConditionalCommand(
          ...
          new SetShooterFarShot(WristAngle.shortPassAngle, ShooterConstants.shooterVelocityShortPassTop, ShooterConstants.shooterVelocityShortPassBottom, shooter, wrist, intake, feeder, ShotMode.SHORT_PASS, robotState, log),
