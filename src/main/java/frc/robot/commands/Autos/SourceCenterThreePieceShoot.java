...
public class SourceCenterThreePieceShoot extends SourceTwoPieceShoot {
  ...
  public SourceCenterThreePieceShoot(Intake intake, Shooter shooter, DriveTrain driveTrain, Feeder feeder, BCRRobotState robotState, TrajectoryCache cache, AllianceSelection alliance, FileLog log, LED led, LEDSegmentRange segment) {
