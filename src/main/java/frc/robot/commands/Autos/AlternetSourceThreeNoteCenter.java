...
public class AlternetSourceThreeNoteCenter extends SequentialCommandGroup {
  /** Creates a new SourceTwoPieceShoot. */
  public AlternetSourceThreeNoteCenter(Intake intake, Wrist wrist, Shooter shooter, DriveTrain driveTrain, Feeder feeder, BCRRobotState robotState, TrajectoryCache cache, AllianceSelection alliance, FileLog log) {
