...
public class AmpFourPieceShoot extends SequentialCommandGroup {
  /** Creates a new AmpFourPieceShoot. */
  public AmpFourPieceShoot(Intake intake, Shooter shooter, DriveTrain driveTrain, Feeder feeder, BCRRobotState robotState, TrajectoryCache cache, AllianceSelection alliance, FileLog log) {
