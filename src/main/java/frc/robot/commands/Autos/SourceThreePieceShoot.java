...
public class SourceThreePieceShoot extends SequentialCommandGroup {
  ...
  public SourceThreePieceShoot(Intake intake, Shooter shooter, DriveTrain driveTrain, Wrist wrist, Feeder feeder, BCRRobotState robotState, TrajectoryCache cache, AllianceSelection alliance, FileLog log) {
